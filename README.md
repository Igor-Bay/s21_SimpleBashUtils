...
В этом проекте мы разрабатывали свою реализацию базового функционала утилит Bash по работе с текстами **cat** и **grep** на языке Си. В рамках выполнения этого проекта предполагалось знакомство с организацией утилит Bash и закрепление структурного подхода.
